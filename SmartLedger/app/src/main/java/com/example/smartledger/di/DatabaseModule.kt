...
object DatabaseModule {
    ...
    /**
     * 提供InvestmentHoldingDao
     */
    @Provides
    @Singleton
    fun provideInvestmentHoldingDao(database: AppDatabase): InvestmentHoldingDao {
        return database.investmentHoldingDao()
    }
}
